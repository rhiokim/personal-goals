...
| Now  | Future      |
|:---------:|:--------------:|
|![](https://avatars3.githubusercontent.com/u/145777?v=3&u=d2a7dc8cc7be849d1e3cfbb98d1550708ccd1c2b&s=400 "" "width:175px")<br/> 김양원(Rhio Kim) | ![](https://dl.dropboxusercontent.com/s/gr3fknlq8twpe4t/%EB%8D%94%EA%B8%80%EB%9D%BC%EC%8A%A4_%ED%81%AC%EB%A1%9D%ED%8F%AC%EB%93%9C.jpeg "" "width:175px;") ![](https://dl.dropboxusercontent.com/s/2y3i4zi0zw67fjr/babros.jpg)<br>Douglas Crockford + Bob Ross

| 연락처 | 이메일 | 생년월일 | 주소 |
|--------|-------|-------|-----|
| 010-8347-9747 | rhio.kim@gmail.com | 1980-04-05 | 서울시 강남구 논현로 106길 |

현재와 미래의 밥로스와 더글라스 크록포드와 같은 사람을 꿈꿉니다.

안녕하세요! 개발자 김양원입니다. 이제 경력과 기술은 년차로 전문성을 인정받는 것보다 개발자로서 세상과 사회를 계속 발전시키는 구성원이 되려고 늘 노력합니다.
...
| 기  간             | 회사 이름     | 부 문                         |
|------------------|:----------:|------------------------------|
| 2017.06.28 - 현재 | (주)트리플 | Tour&Activity, OTA(Online Travel Agency) 플랫폼 개발 |
...
### Triple - 실시간 여행가이드 앱 <small style="font-size: .8rem">https://triple.guide</small>
...
- 역할
> - 모바일 결제 시스템 Vue.js SPA 및 프론트엔드 개발 전담 (이니시스 및 네이버페이 연동)
...
**OTA(Online Travel Agency) 플랫폼** 하나투어와의 계약 실패로 6개월 개발중 중단
숙박(호텔) 정보를 제공하는 공급사(EAN, Agoda, GTA, 하나투어 등)와 숙박 정보가 필요한 판매 사이트를 연결해주기 위한 OTA(Online Travel Agency) 플랫폼
...
> React.js, Vue.js 와 Next.js, Nuxt.js 와 같은 모던 웹 애플리케이션 개발 시에도 경우에 따라 NginX, Node.js Configuration 뿐만 아니라 Cloud 환경에 따라 최적의 Docker Configuration 을 요구한다. 이런 일련의 과정의 자동화 및 최적화를 제공하는 CLI 툴
- Large Scale Frontend Architecture (writing) - https://github.com/rhiokim/large-scale-frontend
> 지난 수년간의 Javascript Application 개발 경험을 바탕으로 대규모의 팀과 애플리케이션을 구축하기 위한 방법론을 작성
...
![](https://raw.githubusercontent.com/rhiokim/gorae/master/media/Gorae.001.png "" "border: 1px solid #ddd")
...
![](https://raw.githubusercontent.com/rhiokim/gorae/master/media/Gorae.002.png "" "border: 1px solid #ddd")
...
- Rhino Icon: 키노트로 그린 코뿔소(자바스크립트를 대표하는 동물) 아이콘
	...
	![](https://raw.githubusercontent.com/rhiokim/rhino-icon/master/media/intro.png "" "border: 1px solid #ddd")
...
- Docker Icon: 키노트로 그린 도커 아이콘
	...
	![](https://raw.githubusercontent.com/rhiokim/docker-icons/master/media/intro.png "" "border: 1px solid #ddd")
...
> - 하이브리드 홈 오토메이션 시스템:
https://vimeo.com/51812784
> - 웹 기반 음성인식 전원제어:
https://vimeo.com/33859298
> - 조도 센서, 온도 센서, 무접점 릴레이
https://vimeo.com/51812784
> - IR 송/수신센서를 이용한 웹 리모콘
https://vimeo.com/53157569
> - webkit-speech API 를 이용한 LED 제어
https://vimeo.com/33859298
